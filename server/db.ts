...
import { InsertUser, users, InsertRsvp, rsvps } from "../drizzle/schema";
...
export async function getRsvpStats() {
  ...
  const declining = all.filter(r => r.attending === "no").length;
  return { total: all.length, attending, declining };
}
